...
public class ServiceMethods {
	 ...
	 * возможностью выбора элементов из этого списка Мышью! - это для Издателей,
	 * Мапперов и Годов - уже не использую
	 */

	public static void choosingWithMouseWindow(List<String> arr) {

		if (arr.size() == 0) {
			ServiceMethods.windowShow("There's no elements in this array.");
			return;
		}
...
///////////////// вот здесь и прописываем основной Экшен для выбранного элемента Массива Строк ////////////////////
					...
					//GameClass.k1 = shit; // присваивем выбранную Строку переменной k1

//////////////////////////////////////////////////////////////////////////////////////////////////////////////////

					/*
					 * Эту часть подсказал GPT, это мгновенно закрывает Окно при нажатии на один из
					 * элементов Списка
					 */
		...
		title = "     You just chose the '' category. Let's choose one of them!";
